...
switch exp
    ...
    case 'naturalsound'
        if optInputs(varargin,'func');
            runtypes = {'main_combined','main_v2_combined','main_v3_combined','natsoundloc','localizer','scrambling','scrambling_russian','texture','texture_combined','spectrotemporal','spectrotemporal_combined','spectrotemporal_v2','spectrotemporal_v2_combined'};
        elseif optInputs(varargin, 'raw_func')
            runtypes = {'main_v3','main','main_v2','natsoundloc','localizer','scrambling','scrambling_russian','texture','spectrotemporal','spectrotemporal_v2'};
        else
            runtypes = {'main_v3','main','main_v2','natsoundloc','localizer','scrambling','scrambling_russian','texture','spectrotemporal','spectrotemporal_v2','struct'};
        end
    ...
    case 'pitch_localizer_monkey'
        if optInputs(varargin,'func');
            runtypes = {'pitchloc2','pitchloc3','pitchloc4','pitchloc2_combined_raw','pitchloc2_combined_split','pitchloc6_combined_raw','pitchloc6_combined_split'};
        elseif optInputs(varargin,'raw_func');
    ...
    case 'voice_localizer_monkey'
        if optInputs(varargin,'func');
            runtypes = {'mvocs_pitch','mvocs_pitch_v2','mvocs_pitch_v3','mvocs_pitch_v4','mvocs_pitch_combined_raw','mvocs_pitch_v2_combined_raw','mvocs_pitch_v3_combined_raw','mvocs_pitch_v4_combined_raw','mvocs_pitch_combined_split','mvocs_pitch_v2_combined_split','mvocs_pitch_v3_combined_split','mvocs_pitch_v4_combined_split'};
        elseif optInputs(varargin,'raw_func');
            runtypes = {'mvocs_pitch','mvocs_pitch_v2','mvocs_pitch_v3','mvocs_pitch_v4'};
        else
            runtypes = {'mvocs_pitch','mvocs_pitch_v2','mvocs_pitch_v3','mvocs_pitch_v4'};
        end
